...
There is NO significant difference in mean weights for Pacific Giant Salamanders between the two forest sections (clear cut & old growth) in 2017. The mean salamander weights for clear cut, `r round(weight_ttest[["estimate"]][1], 2)` grams, and old growth, `r round(weight_ttest[["estimate"]][2], 2)` grams, forest sections do not differ significantly (two-sided t-test, t(`r round(weight_ttest[["parameter"]][1], 0)`) = `r round(weight_ttest[["statistic"]][1], 2)` *p* = `r round(weight_ttest[["p.value"]][1], 3)`)
